...
@section('content')
    <div class="max-w-3xl mx-auto mt-10 bg-white p-8 rounded-xl shadow-lg">
        <h1 class="text-2xl font-bold mb-6 text-gray-800">✏️ Form Edit Gaji Karyawan</h1>
        ...
        <form action="{{ route('salaries.update', $salary->id) }}" method="POST" class="space-y-5">
                ...
                <select name="employees_id" id="employees_id" required
                    ...
                    @foreach ($karyawan as $karyawans)
                        <option value="{{ $karyawans->id }}"
                            {{ old('employees_id', $salary->employees_id ?? '') == $karyawans->id ? 'selected' : '' }}>
            ...
            <div>
                ...
                <input type="month" name="bulan" id="bulan" value="{{ old('bulan', $salary->bulan) }}" required
                    class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500">
            </div>
            ...
            <div>
                ...
                <input type="number" name="gaji_pokok" id="gaji_pokok" min="0"
            ...
            <div>
                ...
                <input type="number" name="tunjangan" id="tunjangan" min="0"
